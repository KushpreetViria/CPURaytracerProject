...
public:
	...
	BVHBoundingBox(Vector _sortAxis, float _x_min, float _y_min, float _z_min, float _x_max, float _y_max, float _z_max)
		: sortAxis(_sortAxis), x_min(_x_min), y_min(_y_min), z_min(_z_min), x_max(_x_max), y_max(_y_max), z_max(_z_max) {}
	...
	static BVHBoundingBox* constructFromObject(Object* object, Vector BVHSortingAxis);
